 ...
 * {@link #update()}).
 */
public abstract class EnergyAwareActiveRouter extends MessageRouter {
...
//	public double thresholdEnergy;
	 ...
	 */
	public EnergyAwareActiveRouter(Settings s) {
		super(s);
...
//			this.thresholdEnergy = 0;
	 ...
	 */
	protected EnergyAwareActiveRouter(EnergyAwareActiveRouter r) {
		super(r);
