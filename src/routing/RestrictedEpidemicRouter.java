 ...
 */
public class RestrictedEpidemicRouter extends ActiveRouter {
	 ...
	 */
	public RestrictedEpidemicRouter(Settings s) {
		super(s);
	 ...
	 */
	protected RestrictedEpidemicRouter(RestrictedEpidemicRouter r) {
		super(r);
	...
	@Override
	public RestrictedEpidemicRouter replicate() {
		return new RestrictedEpidemicRouter(this);
	}
