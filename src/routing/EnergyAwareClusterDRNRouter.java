 ...
 */
public class EnergyAwareClusterDRNRouter extends EnergyAwareRouter {
	 ...
	 */
	public EnergyAwareClusterDRNRouter(Settings s) {
		super(s);
	 ...
	 */
	protected EnergyAwareClusterDRNRouter(EnergyAwareClusterDRNRouter r) {
		super(r);
	...
	@Override
	public EnergyAwareClusterDRNRouter replicate() {
		return new EnergyAwareClusterDRNRouter(this);
	}
