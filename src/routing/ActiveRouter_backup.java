 ...
 * {@link #update()}).
 */
public abstract class ActiveRouter_backup extends MessageRouter {
...
//	public static final String RELIEF_CENTER = "reliefCenter";
//	public static String reliefCenter;
//	public static final String RESCUE_WORKER = "rescueWorker";
//	public String rescueWorker;
//	public static final String POTENTIAL_EXEMPLAR_LIST = "potentialExemplarList";
//	public String potentialExemplarList;
//	public static final String THRESHOLD_ENERGY = "thresholdEnergy";
//	public double thresholdEnergy;
	 ...
	 */
	public ActiveRouter_backup(Settings s) {
		super(s);
...
//		if(s.contains(RELIEF_CENTER))
//			this.reliefCenter = s.getSetting(RELIEF_CENTER);
//		else
//			this.reliefCenter = null;
//
//		if(s.contains(RESCUE_WORKER))
//			this.rescueWorker = s.getSetting(RESCUE_WORKER);
//		else
//			this.rescueWorker = null;
//		if(s.contains(POTENTIAL_EXEMPLAR_LIST)){
//			this.potentialExemplarList = s.getSetting(POTENTIAL_EXEMPLAR_LIST);
//			
//		}
//			
//		else
//			this.potentialExemplarList = null;
//		if(s.contains(THRESHOLD_ENERGY))
//			this.thresholdEnergy = s.getDouble(THRESHOLD_ENERGY);
//		else
//			this.thresholdEnergy = 0;
	 ...
	 */
	protected ActiveRouter_backup(ActiveRouter_backup r) {
		super(r);
		this.deleteDelivered = r.deleteDelivered;
//		this.rescueWorker = r.rescueWorker;
//		this.reliefCenter = r.reliefCenter;
//		this.potentialExemplarList = r.potentialExemplarList;
//		this.thresholdEnergy = r.thresholdEnergy;
	}
...
//	public void computeExemplars(){
//		ArrayList<DTNHost> relayExemplars = new ArrayList<DTNHost>();
//		double minEnergy = 1;
//		int minNumberOfExemplars =2;
//		
...
//		
//		if(!potentialExemplar.toString().startsWith("CD") && !potentialExemplar.toString().startsWith("DB") && 
//				!potentialExemplar.toString().startsWith("relief") && potentialExemplar.getEnergy()>minEnergy){
//			potentialExemplar.setRelayExemplar(false);
//			relayExemplars.add(potentialExemplar);
//		}
//		//System.out.println("The connections are "+getConnections().toString()+" other: "+getHost().getConnections());
...
////		System.out.println("The relay exemplar list is ");
////		for(DTNHost host: relayExemplars){
////			System.out.println(host.toString()+ " - " + host.getContactFrequency()+ " - "+ host.getEnergy());
////		}
...
//		}
//		System.out.println("-----------");
////		//check if current host is exemplar
////		if(this.potentialExemplarList!=null && this.potentialExemplarList.contains(potentialExemplar.toString())){
////			//System.out.println("The exemplars are " + potentialExemplar.toString());
////			potentialExemplar.setRelayExemplar(true);
////			//System.out.println("Current victim node is relay exemplar" + potentialExemplar.getRelayExemplar());
////		}
////		//check for all neighboring nodes
////		for (Connection con : getConnections()) {
////				potentialExemplar = con.getOtherNode(getHost());
////				//System.out.println("The list is: " + this.potentialExemplarList);
////				//System.out.println("Computer Exemplar " + potentialExemplar.toString());
////				if(this.potentialExemplarList!=null && this.potentialExemplarList.contains(potentialExemplar.toString())){
////					//System.out.println("The exemplars are " + potentialExemplar.toString());
////					potentialExemplar.setRelayExemplar(true);
////					//System.out.println("Current victim node is relay exemplar" + potentialExemplar.getRelayExemplar());
...
//		//if total time > any node interacts with 
//		//rescue worker in that neighbourhood
//		return true;
//	}
//	protected boolean shouldSendMessage(Message m,DTNHost n,Connection con)
//	{
//		DTNHost x,y;
//		x = getHost();
//		y = con.getOtherNode(getHost());
//		//if(!x.toString().contains("n")){
//			//System.out.println("The connecting nodes are: " + x.toString()+" <--->" + y.toString());
//		//}
//		computeExemplars();
//		
//		/*if(		(x.toString().contains("DB") && y.toString().contains("CD"))||
//				(x.toString().contains("CD") && y.toString().contains("DB"))||
//				(x.getRelayExemplar() && y.toString().contains("CD"))||
//				(y.getRelayExemplar() && x.toString().contains("CD"))||
//				(!x.getRelayExemplar() && y.getRelayExemplar())||
//				(x.getRelayExemplar() && !y.getRelayExemplar())){
//			return true;
//		}*/
//		if(!x.getRelayExemplar() && !y.getRelayExemplar()){
//			return false;
//		}
//		else
//			return true;
...
//	}
	...
	protected int startTransfer(Message m, Connection con) {	
		...
		if (retVal == RCV_OK) { // started transfer
			...
			System.out.println(" The message is already delivered: "+m.getId()+" from: "+ m.getFrom()+" "+m.getTo());
	...
	protected boolean canStartTransfer() {
		...
		//increment the contact frequency count of non rescue worker if the other is a rescue worker
	...
	protected void dropExpiredMessages() {
		...
		for (int i=0; i<messages.length; i++) {
			...
			if (ttl <= 0) {
				//System.out.println("Here I dropped some messages" );
...
//				y = con.getOtherNode(getHost());
//				if(this.rescueWorker.contains(y.toString())){
//					x.setContactFrequency(x.getContactFrequency()+1);
//					//System.out.println("Inside update contact Frequency "+x.toString()+ " "+y.toString() + x.getContactFrequency());
//				}
//				else if(this.rescueWorker.contains(x.toString())){
//					y.setContactFrequency(y.getContactFrequency()+1);
...
//	}
	...
	public void update() {
		...
		super.update();
		//System.out.println("Active Router");
