 ...
 */
public class EnergyAwareRestrictedEpidemicRouter extends RestrictedEpidemicRouter 
	 ...
	 */
	public EnergyAwareRestrictedEpidemicRouter(Settings s) {
		super(s);
	 ...
	 */
	protected EnergyAwareRestrictedEpidemicRouter(EnergyAwareRestrictedEpidemicRouter r) {
		super(r);
...
//		}
	...
	@Override
	public EnergyAwareRestrictedEpidemicRouter replicate() {
		return new EnergyAwareRestrictedEpidemicRouter(this);
	}
