 ...
 * the warmup period.
 */
public class NodeInformationReport extends Report implements UpdateListener {
...
//				getProperty("Energy.value");
			...
			NodeInformation nodeInf = h.getNodeInformation();
			String str = "";
			//boolean isExemplar = h.isExemplar();
			if(nodeInf!=null)
			{	
				str = getSimTime()+"   id: "+ h.toString() + " wF: " + nodeInf.getWeightedFitness()+"  cF: "+ nodeInf.getContactFitnessWithNodeK(nodeInf.getExemplarId())+" X: "+nodeInf.getExemplarId();
				str +=" [";
