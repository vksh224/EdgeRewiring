 ...
 * the warmup period.
 */
public class LNeighborhoodReport extends Report implements UpdateListener {
...
//				getProperty("Energy.value");
			...
			DTNHost lNeighborhood = h.getlNeighborhoodId();
			boolean isExemplar = h.isExemplar();
			
			write(getSimTime()+"   "+h.toString() + " " +" "+h.getlNeighborhoodId()+" "+h.isExemplar()+" "+ h.getConnections().toString());
		}
